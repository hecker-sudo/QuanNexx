(function() {
  ...
  // Clickoff Check
  var defaultTitle = 'QuanNex | V1';
  var defaultIcon = '/assets/img/QuanNex.jpg';
  var storedTitle = localStorage.getItem('tabTitle');
  var storedIcon = localStorage.getItem('tabIcon');
  var icon = document.querySelector('link[rel="icon"]');
  var newTitle = storedTitle || defaultTitle;
  ...
  if (storedIcon === '/assets/img/QuanNex.jpg' || storedIcon === null || storedIcon === '') {
      localStorage.setItem('tabIcon', '/assets/img/QuanNex.jpg');
  }
